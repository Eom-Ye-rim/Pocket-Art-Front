...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/fk_user_agent/fk_user_agent.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_appauth/flutter_appauth.framework"
