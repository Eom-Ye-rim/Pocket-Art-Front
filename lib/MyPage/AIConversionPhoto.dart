...
class AIConversionPhoto extends StatefulWidget {
  ...
  const AIConversionPhoto({Key? key, required this.photo ,required this.responseData}) : super(key: key);

  @override
  State<AIConversionPhoto> createState() => _PaintingStyleConversionPhotoState();
}

class _PaintingStyleConversionPhotoState extends State<AIConversionPhoto> {
