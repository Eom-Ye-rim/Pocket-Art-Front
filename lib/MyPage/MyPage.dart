...
class MyPage extends StatefulWidget {
  ...
  const MyPage({Key? key, required this.responseData}) : super(key: key);
...
class _MyPageState extends State<MyPage> {
  ...
  void initState() {
    super.initState();
    name=widget.responseData['data']['name'];
    user_Img=widget.responseData['data']['profileImg'];
  }
                              ...
                              children: [
                                InkWell(
                                  onTap: () {
                                    ...
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(builder: (context) => ProfileSetting(responseData: widget.responseData)),
                                    );
                                  },
                                  child: Container(
                                    width: 40,
                          ...
                          Row(
                            children: [
                              TextButton(
                                onPressed: () async {
                                  final dio = Dio();
                                  final String apiUrl = 'http://54.180.79.174:8080/api/v1/my/all?boardType=AI';
                                ...
                                try {
                                  ...
                                  if (response.statusCode == 200) {
                                    ...
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(builder: (context) => AIConversionPhoto(photo:response.data,responseData: widget.responseData)),
                                    );
                                    print(data);
                                  }
                                  else {
                          ...
                          Row(
                            children: [
                              TextButton(
                                onPressed: () async {
                                  final dio = Dio();
                                  final String apiUrl = 'http://54.180.79.174:8080/api/v1/my/all?boardType=일반';
                                  SharedPreferences prefs = await SharedPreferences.getInstance();
                                  ...
                                  try {
                                    ...
                                    if (response.statusCode == 200) {
                                      ...
                                      Navigator.push(
                                        context,
                                        MaterialPageRoute(builder: (context) => PaintingStyleConversionPhoto(photo:response.data,responseData: widget.responseData)),
                                      );
                                      print(data);
                                    }
                                    else {
                            ...
                            children: [
                              TextButton(
                                onPressed: () {
                                  ...
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(builder: (context) => MyPost(responseData: widget.responseData)),
                                  );
                                },
                                child: Text(
                                  '내가 올린 게시글',
                            ...
                            children: [
                              TextButton(
                                onPressed: () {
                                  ...
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(builder: (context) => FavoritePhoto(responseData: widget.responseData)),
                                  );
                                },
                                child: Text(
                                  '내가 좋아요한 사진',
