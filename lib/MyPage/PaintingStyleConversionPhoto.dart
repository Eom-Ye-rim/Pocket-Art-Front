...
class PaintingStyleConversionPhoto extends StatefulWidget {
  final dynamic photo;
  final dynamic responseData;

  // final dynamic responseData;
  const PaintingStyleConversionPhoto({Key? key,required this.photo, required this.responseData}) : super(key: key);

  @override
  State<PaintingStyleConversionPhoto> createState() => _PaintingStyleConversionPhotoState();
}

class _PaintingStyleConversionPhotoState extends State<PaintingStyleConversionPhoto> {
  List<String> photolist = [];
  @override
  void initState() {
    super.initState();

    photolist = (widget.photo as List<dynamic>?)?.cast<String>() ?? [];
    print(photolist);
  }
  int _currentIndex = 0;
          ...
          child: Column(
            children: [
              Container(
                ...
                child: GridViewPhotos(photoList:photolist),
              ),
            ],
          ),
        ),
...
class GridViewPhotos extends StatefulWidget {
  ...
  const GridViewPhotos({Key? key, required this.photoList}) : super(key: key);

  @override
  State<GridViewPhotos> createState() => _GridViewPhotosState(photoList: photoList);
}
...
class _GridViewPhotosState extends State<GridViewPhotos> {
  ...
  _GridViewPhotosState({required this.photoList});

  @override
  void initState() {
    super.initState();

    images = createPhotos(context, photoList);
  }
...
List<Widget> createPhotos(BuildContext context, List<String> photoUrls) {
  List<Widget> images = [];
  print("photoList+ ${photoUrls}");
